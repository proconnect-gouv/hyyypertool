...
import { decodeHtmlEntities } from "#src/ui/moderations/TemplateEditor";
...
export default function Page({
  ...
  return (
    <main class="fr-container my-12">
      <div class="fr-mb-3w flex items-baseline justify-between">
        <h1 class="fr-mb-0">Templates de réponse</h1>
        <a

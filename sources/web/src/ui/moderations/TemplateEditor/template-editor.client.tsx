...
import { decodeHtmlEntities, render } from "#src/lib/moderations";
...
export function TemplateEditor({
  ...
  return (
    <>
      <input type="hidden" name="label" value={label.value} />
...
function TemplateEditorPanel({
  ...
  return (
    <div class="fr-mb-2w">
      ...
      <label class="fr-label fr-sr-only" htmlFor="template-input">
        Contenu du template
      </label>
      <textarea
        class="fr-input"
